  ...
  <div style={styles.inputWrap}>
   ...
   {isPassword && (
    <button type="button" style={styles.togglePw} onClick={() => setShowPw((s) => !s)}>
     {showPw
      ? <svg width="17" height="17" viewBox="0 0 18 18" fill="none"><path d="M1 9s3-5.5 8-5.5S17 9 17 9s-3 5.5-8 5.5S1 9 1 9z" stroke="#9B7B77" strokeWidth="1.4"/><circle cx="9" cy="9" r="2.5" stroke="#9B7B77" strokeWidth="1.4"/><path d="M2 2l14 14" stroke="#9B7B77" strokeWidth="1.4" strokeLinecap="round"/></svg>
      : <svg width="17" height="17" viewBox="0 0 18 18" fill="none"><path d="M1 9s3-5.5 8-5.5S17 9 17 9s-3 5.5-8 5.5S1 9 1 9z" stroke="#9B7B77" strokeWidth="1.4"/><circle cx="9" cy="9" r="2.5" stroke="#9B7B77" strokeWidth="1.4"/></svg>
     }
    </button>
   )}
  </div>
...
export default function DonorRegisterPage() {
 ...
 if (done) return (
  <div style={{ ...styles.page, alignItems: "center", justifyContent: "center", background: "#FDF4F2" }}>
    <div style={styles.successBox}>
    <div style={{ width:72, height:72, background:"rgba(30,132,73,.1)", borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto 20px" }}><svg width="36" height="36" viewBox="0 0 36 36" fill="none"><circle cx="18" cy="18" r="15" stroke="#1E8449" strokeWidth="2"/><path d="M10 18l6 6 10-12" stroke="#1E8449" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
      ...
      <div>
       <div style={styles.fieldRow}>
        <Field label="Full Name" required error={touched.fullName && errors.fullName}>
         <InputField icon={<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5" r="3" stroke="#9B7B77" strokeWidth="1.3"/><path d="M2 14c0-3.314 2.686-6 6-6s6 2.686 6 6" stroke="#9B7B77" strokeWidth="1.3" strokeLinecap="round"/></svg>} value={form.fullName} placeholder="Jean Claude Niyomugabo"
        ...
        <Field label="Phone Number" required error={touched.phone && errors.phone} helper="e.g. 0788123456">
         <InputField icon={<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="3" y="1" width="10" height="14" rx="2" stroke="#9B7B77" strokeWidth="1.3"/><circle cx="8" cy="12" r="1" fill="#9B7B77"/></svg>} value={form.phone} placeholder="0788 123 456"
       ...
       <Field label="Blood Type" required error={touched.bloodType && errors.bloodType}>
        <SelectField icon={<svg width="16" height="16" viewBox="0 0 18 18" fill="none"><path d="M9 2C9 2 3 8.5 3 12a6 6 0 0 0 12 0C15 8.5 9 2 9 2z" stroke="#9B7B77" strokeWidth="1.4" strokeLinejoin="round"/><path d="M6.5 13a2.5 2.5 0 0 0 2.5 2" stroke="#9B7B77" strokeWidth="1.4" strokeLinecap="round"/></svg>} value={form.bloodType}
     ...
     {step === 2 && (
      <div>
       <Field label="Password" required error={touched.password && errors.password}
        ...
        <InputField icon={<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="3" y="7" width="10" height="8" rx="1.5" stroke="#9B7B77" strokeWidth="1.3"/><path d="M5 7V5a3 3 0 016 0v2" stroke="#9B7B77" strokeWidth="1.3"/><circle cx="8" cy="11" r="1" fill="#9B7B77"/></svg>} type="password" value={form.password} placeholder="Create a strong password"
       ...
       <Field label="Confirm Password" required error={touched.confirmPassword && errors.confirmPassword}>
        <InputField icon={<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="3" y="7" width="10" height="8" rx="1.5" stroke="#9B7B77" strokeWidth="1.3"/><path d="M5 7V5a3 3 0 016 0v2" stroke="#9B7B77" strokeWidth="1.3"/><circle cx="8" cy="11" r="1" fill="#9B7B77"/></svg>} type="password" value={form.confirmPassword} placeholder="Re-enter your password"
...
const styles = {
 ...
 input:     { width: "100%", padding: "11px 14px 11px 38px", border: "1.5px solid #DDD5D0", borderRadius: 9, fontFamily: "'Sora', sans-serif", fontSize: 14, color: "#1C1C1C", outline: "none", transition: "border-color 0.2s", boxSizing: "border-box" },
